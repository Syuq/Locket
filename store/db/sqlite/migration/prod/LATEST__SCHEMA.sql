...
CREATE INDEX idx_locket_creator_id ON locket (creator_id);
CREATE INDEX idx_locket_content ON locket (content);
CREATE INDEX idx_locket_visibility ON locket (visibility);
