...
import { Dropdown, IconButton, Link, Menu, MenuButton, MenuItem } from "@mui/joy";
    ...
    <Dropdown>
      ...
      <Menu className="text-sm" size="sm" placement="bottom-start">
        ...
        <div className="-mt-0.5 pl-2">
          <Link fontSize={12} href="https://www.duyquys.id.vn/docs/getting-started/content-syntax" target="_blank">
            Content syntax
          </Link>
        </div>
      </Menu>
